...
# === DODANY KOLOR TŁA DLA EKRANU INSTRUKCJI ===
INSTRUCTIONS_SCREEN_BG_COLOR = (50, 50, 150) # Ciemnoniebieski, który był wcześniej zakodowany na stałe
...
PLAYER_WIDGET_POINTS_FONT_SIZE = 30 # Dla licznika punktów i animacji "+1"
NAME_INPUT_FONT_SIZE = 40; NAME_INPUT_LABEL_FONT_SIZE = 35; QUESTION_CARD_QUESTION_FONT_SIZE = 32
QUESTION_CARD_ANSWER_FONT_SIZE = 28; QUESTION_CARD_ANSWER_LABEL_FONT_SIZE = 48
FEEDBACK_FONT_SIZE = 48 # Ta stała była z usuniętego feedback_card, można ją usunąć lub zostawić

# --- Ustawienia Punktacji ---
POINTS_FOR_CORRECT_ANSWER = 1; POINTS_FOR_SCHOLARSHIP = 2; POINTS_FOR_RETAKE = -2
POINTS_FOR_EXAM_CORRECT = 1; POINTS_FOR_EXAM_INCORRECT = -1
...
GAMEPLAY_PANEL_BUTTON_WIDTH = 220; GAMEPLAY_PANEL_BUTTON_HEIGHT = 70; GAMEPLAY_PANEL_BUTTON_SPACING = 20; MAX_PLAYER_NAME_LENGTH = 20

# --- Ustawienia Ekranu Wprowadzania Imion ---
NAME_INPUT_BOX_WIDTH = 450; NAME_INPUT_BOX_HEIGHT = 60; NAME_INPUT_LABEL_Y_OFFSET = -50; NAME_INPUT_LABEL_X_OFFSET = 0
...
ANSWER_D_CLICK_RECT = pygame.Rect(89, 845, 436, 77); ANSWER_TEXT_AREA_PADDING_X = 50; ANSWER_TEXT_AREA_PADDING_Y = 5
ANSWER_LABEL_CENTER_X = 40; ANSWER_HOVER_BORDER_RADIUS = 10; FEEDBACK_DURATION_SECONDS = 2.0; INTER_QUESTION_DELAY_SECONDS = 0.4

# --- Ustawienia Kostki ---
DICE_IMAGE_WIDTH = 120; DICE_IMAGE_HEIGHT = 120; DICE_ANIMATION_DURATION_SECONDS = 0.5; DICE_ANIMATION_FRAME_DURATION_SECONDS = 0.05
...
PLAYER_WIDGET_1_Y_OFFSET = 30; PLAYER_WIDGET_VERTICAL_SPACING = 15
# Pozycjonowanie Tekstu w Widgecie
PLAYER_WIDGET_TEXT_X_PADDING = 140; PLAYER_WIDGET_TEXT_Y_OFFSET = -7
# Pozycjonowanie ECTS w Widgecie
...
# Pozycjonowanie animacji "pływającego tekstu"
PLAYER_WIDGET_FLOATING_TEXT_X_OFFSET = 30
PLAYER_WIDGET_FLOATING_TEXT_Y_OFFSET = -10
# === DODANA STAŁA DLA PRĘDKOŚCI ANIMACJI PUNKTÓW ===
FLOATING_TEXT_SPEED_Y = -30 # Prędkość unoszenia się w pikselach na sekundę (ujemna, bo oś Y rośnie w dół)
FLOATING_TEXT_DURATION_SECONDS = 1.0 # Czas życia animacji

# --- Ustawienia Komunikatu o Błędzie Wprowadzania Imion ---
NAME_ERROR_FONT_SIZE = 24
NAME_ERROR_COLOR = (200, 0, 0)
NAME_ERROR_DURATION_SECONDS = 1.0
NAME_ERROR_Y_OFFSET = 10

# --- Ustawienia Animacji Punktów ---
FLOATING_TEXT_SPEED_Y = -30 # Prędkość unoszenia się w pikselach na sekundę
FLOATING_TEXT_DURATION_SECONDS = 1.0 # Czas życia animacji

# --- Kolor Tła dla Ekranu Instrukcji ---
INSTRUCTIONS_SCREEN_BG_COLOR = (50, 50, 150)